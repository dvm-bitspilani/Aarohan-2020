...
for(var i = 0; i < faqcontainer.length; i++) {
    ...
    faqcontainer[0].addEventListener('click',function(){
        if(!alreadyOpen[0]){
            ...
            faqcontainer[0].style.height="4vh";
    ...
    faqcontainer[1].addEventListener('click',function(){
        if(!alreadyOpen[1]){
            ...
            faqcontainer[1].style.height="4vh";
    ...
    faqcontainer[2].addEventListener('click',function(){
        if(!alreadyOpen[2]){
            ...
            faqcontainer[2].style.height="4vh";
            faqcontainer[2].style.width = "55vw";
            faqcontainer[2].style.border = "1px solid #707070";
            faqcontainer[2].style.background = "none";
            alreadyOpen[2]=false;
        }
    })
    faqcontainer[3].addEventListener('click',function(){
        if(!alreadyOpen[3]){
            ...
            faqcontainer[3].style.height="4vh";
            faqcontainer[3].style.border = "1px solid #707070";
            faqcontainer[3].style.background = "none";
            alreadyOpen[3]=false;
        }
    })
    faqcontainer[4].addEventListener('click',function(){
        if(!alreadyOpen[4]){
            ...
            faqcontainer[4].style.height="4vh";
            faqcontainer[4].style.border = "1px solid #707070";
            faqcontainer[4].style.background = "none";
            alreadyOpen[4]=false;
        }
    })
    faqcontainer[5].addEventListener('click',function(){
        if(!alreadyOpen[5]){
            ...
            faqcontainer[5].style.height="4vh";
            faqcontainer[5].style.border = "1px solid #707070";
            faqcontainer[5].style.background = "none";
            alreadyOpen[5]=false;
        }
    })
